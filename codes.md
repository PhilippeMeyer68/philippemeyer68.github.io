...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Retrobiosynthesis &middot; Synthesis planning &middot; LLM agents &middot; LLM fine-tuning &middot; Tree search</span>
  <span class="code-stack"><span class="code-label">Tools:</span> RDKit &middot; PyTorch &middot; Hugging Face TRL &middot; PEFT &middot; Qwen2.5 &middot; vLLM &middot; Slurm (GPU cluster)</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Reaction informatics &middot; Reaction rules &middot; Atom mapping &middot; Enzyme function prediction &middot; Reaction classification</span>
  <span class="code-stack"><span class="code-label">Tools:</span> RDKit &middot; RXNMapper &middot; scikit-learn &middot; SciPy &middot; NumPy &middot; pandas &middot; Slurm (HPC cluster)</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Microbial biosensors &middot; Clinical diagnostics &middot; Time-series classification &middot; Hyperparameter optimization &middot; Mixed models</span>
  <span class="code-stack"><span class="code-label">Tools:</span> PyTorch &middot; scikit-learn &middot; XGBoost &middot; Optuna &middot; Ray &middot; mgcv (R) &middot; Matplotlib</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Synthetic biology &middot; Microbial biocomputing &middot; Genome-scale metabolic models &middot; Flux balance analysis &middot; Hybrid mechanistic–ML models</span>
  <span class="code-stack"><span class="code-label">Tools:</span> TensorFlow / Keras &middot; COBRApy &middot; scikit-learn &middot; XGBoost &middot; SciPy &middot; pandas</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Cheminformatics &middot; Molecular fingerprints &middot; Inverse QSAR &middot; Molecular enumeration &middot; Combinatorics</span>
  <span class="code-stack"><span class="code-label">Tools:</span> RDKit &middot; SymPy &middot; NetworkX &middot; SciPy &middot; NumPy &middot; pandas</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Generative chemistry &middot; De novo molecular design &middot; Chemical language models &middot; Transfer learning</span>
  <span class="code-stack"><span class="code-label">Tools:</span> PyTorch &middot; Lightning &middot; TorchMetrics &middot; RDKit &middot; SentencePiece &middot; TensorBoard &middot; pandarallel</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Computational algebra &middot; Integer linear systems &middot; Combinatorics</span>
  <span class="code-stack"><span class="code-label">Tools:</span> NumPy &middot; hsnf &middot; pytest &middot; pytest-cov</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Computer vision &middot; Metric learning &middot; Few-shot learning &middot; Clustering &middot; Digital humanities</span>
  <span class="code-stack"><span class="code-label">Tools:</span> TensorFlow / Keras &middot; OpenCV &middot; scikit-image &middot; scikit-learn &middot; SciPy &middot; Plotly &middot; Pillow</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Topological data analysis &middot; 3D shape analysis &middot; Anomaly detection &middot; Clustering &middot; Anthropometry</span>
  <span class="code-stack"><span class="code-label">Tools:</span> GUDHI &middot; POT &middot; scikit-learn &middot; SciPy &middot; meshio &middot; Matplotlib &middot; pytest</span>
</li>
...
<li>
  ...
  <span class="code-topics"><span class="code-label">Fields:</span> Survey statistics &middot; Survey calibration &middot; Anthropometry &middot; Data visualization &middot; Data security</span>
  <span class="code-stack"><span class="code-label">Tools:</span> R Shiny &middot; icarus &middot; plotly &middot; ggplot2 &middot; rstatix &middot; sodium &middot; Docker</span>
